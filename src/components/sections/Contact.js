...
const Contact = (props) => {
  ...
  return (
    <div>
      ...
      <h3 className={classes.contactText}><span className={classes.blueText}>Phone</span> - 678-446-1512</h3>

      <div className={classes.btnSection}>
        <Button variant='fab' className={classes.contactBtn} href="https://www.linkedin.com/in/michael-gee/" target="_blank">
          <Icon icon={LINKEDIN} />
        </Button>
        <Button variant='fab' className={classes.contactBtn} href="https://twitter.com/michaelgee7" target="_blank">
          <Icon icon={TWITTER} />
        </Button>
