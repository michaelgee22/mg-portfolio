...
import { LINKEDIN, GITHUB, EMAIL, PHONE, LOCATION } from '../Icon/IconList'

import { useStyles } from './styles'

const Jumbotron = ({ triggerComponentScroll }) => {
    ...
    <header>
      <div className={classes.topBar}>
        <div className={classes.topBarIcons}>
          <IconButton className={classes.topBarIcon} href="https://www.linkedin.com/in/michael-gee/" target="_blank">
            <Icon icon={LINKEDIN} />
          </IconButton>
      ...
      <div className={classes.navSection}>
        <Button className={classes.navBtn} onClick={() => triggerComponentScroll('experience')}>
          Experience
        </Button>
        <Button className={classes.navBtn} onClick={() => triggerComponentScroll('skills')}>
          Skills
        </Button>
        <Button className={classes.navBtn} onClick={() => triggerComponentScroll('portfolio')}>
          Portfolio
        </Button>
        <Button className={classes.navBtn} onClick={() => triggerComponentScroll('education')}>
          Education
        </Button>
        <Button className={classes.navBtn} onClick={() => triggerComponentScroll('contact')}>
          Contact
        </Button>
      </div>
    </header>
